...
/**
 * La classe si occupa di gestire l'interfaccia utente (CLI) e la comunicazione con il server; la connessione avviene tramite il meccanisco delle socket
 * La classe stampa anche dei messaggi informativi per guidare l'utente nelle scelte
 */
